...
public class Data {
    ...
    }//DataCompleta(boolean week, String day_month, String month_year)
    
    public String DataCompleta(boolean week){
        
        return this.DataCompleta(week, ", dia ", " de ") + "!";
        
    }//DataCompleta(boolean week)
    
    public String DataCompleta(String day_month){
        
        return this.DataCompleta(true, day_month, " de ");
        
    }//DataCompleta(String day_month)
    
    public String DataCompleta(String day_month, String month_year){
        
        return this.DataCompleta(true, day_month, month_year);
        
    }//DataCompleta(String day_month, String month_year)
    
    public String DataCompleta(boolean week, String month_year){
    ...
    private int CompareDay(){
        ...
        return (this.data.getMonthValue() * 1_00) +
            this.data.getDayOfMonth();
        
    }//CompareDay()
    
    public boolean CompareDay(Data d){
        
        return this.CompareDay() == d.CompareDay();
        
    }//CompareDay(Data d)
    
    public boolean CompareDay(Data d, boolean code){
    ...
    }//CompareDay(Data d, boolean code)
    
    private int CompareTo(){
        
        return (this.data.getYear() * 1_00_00) +
            (this.data.getMonthValue() * 1_00) +
            this.data.getDayOfMonth();
    ...
    public boolean CompareTo(Data d, boolean code){
